...
export default function ShopComponent() {
    ...
    const card = { width: "300px", "marginRight": "auto", "marginLeft": "auto", "marginBottom": "5px", "borderColor": "gray", "marginTop": "1.5rem" ,height:"450px" };
    ...
    return(
        ...
        <center>
            <div  style={{display:"flex",width: "1850px",height:"550px",flexWrap:"wrap"}}>
